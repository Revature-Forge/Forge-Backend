...
--PROJECT
INSERT INTO PROJECTS (PROJECTID, DESCRIPTION, NAME, RESPONSIBILITIES, RESPOSITORY_URL, TECHNOLOGIES, WORK_PRODUCTS,  ID) VALUES (1,'ll�sime peripherique annoncer enfants enfants vachement nuit formidable encombr� �panoui chiots. Arc truc cacato�s lorem fl�ner.','PROJECT NAME', 'RESPONSIBILITIES','URL','','',1);

--WORKEXPERIENCE
INSERT INTO WORKEXPERIENCE (WORKEXPERIENCEID, DESCRIPTION, EMPLOYER, END_DATE, RESPONSIBILITIES, START_DATE, TECHNOLOGIES, TITLE, ID) VALUES (1, '', '', '2020-10-11', '', '2020-10-11', '', '', 1);

--WORKHISTORY
INSERT INTO WORKHISTORY (ID, DESCRIPTION, EMPLOYER, END_DATE, RESPONSIBILITIES, START_DATE, TITLE, TOOLS, PORTFOLIO_ID) VALUES (1, '', '', '2020-10-11', '', '2020-10-11', '', '', 1);
